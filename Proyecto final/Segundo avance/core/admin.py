...
from .models import entidad_F, ciudad, cliente, venta, paqueteria, estado, entrega, metoPago, pago, categoria, producto, venta_producto, proveedor, compra, compra_producto
